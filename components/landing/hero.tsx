...
export function Hero() {
    return (
        <>
            ...
            {/* Main Hero Content */}
            <div className="relative min-h-screen bg-black overflow-hidden flex flex-col justify-center items-center pt-24 font-sans antialiased text-white selection:bg-green-500/30">
                <div className="container mx-auto px-6 z-10 flex flex-col items-center">
                    ...
                    <div className="text-center max-w-4xl mx-auto mb-[70px] mt-[15px] relative z-20 mr-[0px] ml-[0px]">
                        ...
                        >
                            <button className="group w-48 h-14 bg-[#1C1A1C] rounded-full flex items-center justify-center gap-3 cursor-pointer transition-all duration-500 ease-in-out hover:bg-gradient-to-t hover:from-[#A47CF3] hover:to-[#683FEA] hover:shadow-[inset_0px_1px_0px_0px_rgba(255,255,255,0.4),inset_0px_-4px_0px_0px_rgba(0,0,0,0.2),0px_0px_0px_4px_rgba(255,255,255,0.2),0px_0px_180px_0px_#9917FF] hover:-translate-y-0.5">
